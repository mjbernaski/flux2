...
# 2. Opens Windows Firewall for the flux web server (2222) and image
#    manager (2223) on the private/domain profiles.
#
...
Write-Host "== Adding firewall rules for ports 2222/2223 ==" -ForegroundColor Cyan
